<template>
    ...
    <article class="m-auto">
        ...
        <div class="skills flex flex-row gap-5 mb-16">
            ...
            <div class="w-max flex flex-col items-center text-blue-500 shadow-sm shadow-blue-400 rounded-lg">
            ...
            <div class="w-max flex flex-col items-center text-pink-500 shadow-sm shadow-pink-400 rounded-lg">
            ...
            <div class="w-max flex flex-col items-center text-yellow-600 shadow-sm shadow-yellow-500 rounded-lg">
            ...
            <div class="w-max flex flex-col items-center text-indigo-600 shadow-sm shadow-indigo-500 rounded-lg">
            ...
            <div class="w-max flex flex-col items-center text-blue-700 shadow-sm shadow-blue-600 rounded-lg">
        ...
        <div class="skills flex flex-row gap-5 mb-16">
            ...
            <div class="w-max flex flex-col items-center text-emerald-500 shadow-sm shadow-emerald-400 rounded-lg">
        ...
        <div class="skills flex flex-row gap-5 mb-10">
            <div class="w-max flex flex-col items-center text-rose-900 shadow-sm shadow-rose-800 rounded-lg">
            ...
            <div class="w-max flex flex-col items-center text-gray-300 shadow-sm shadow-gray-200 rounded-lg">
            ...
            <div class="w-max flex flex-col items-center text-slate-400 shadow-sm shadow-slate-300 rounded-lg">
            ...
            <div class="w-max flex flex-col items-center text-sky-600 shadow-sm shadow-sky-500 rounded-lg">
