<template>
    ...
    <article class="m-auto">
        <p class="title text-xl text-slate-50 text-justify mb-10">I have a strong foundation in the following languages :</p>
        <div class="skills flex flex-row gap-5 mb-16">
            <div class="w-max flex flex-col items-center text-orange-500 shadow-sm shadow-orange-400 rounded-lg hover:scale-110 transition duration-700">
            ...
            <div class="w-max flex flex-col items-center text-blue-500 shadow-sm shadow-blue-400 rounded-lg hover:scale-110 transition duration-700">
           
                <svg class="fill-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                    <path
            ...
            <div class="w-max flex flex-col items-center text-pink-500 shadow-sm shadow-pink-400 rounded-lg hover:scale-110 transition duration-700">
                <svg class="fill-pink-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                    <path
            ...
            <div class="w-max flex flex-col items-center text-yellow-600 shadow-sm shadow-yellow-500 rounded-lg hover:scale-110 transition duration-700">
                <svg class="fill-yellow-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path
                        d="M0 32v448h448V32H0zm243.8 349.4c0 43.6-25.6 63.5-62.9 63.5-33.7 0-53.2-17.4-63.2-38.5l34.3-20.7c6.6 11.7 12.6 21.6 27.1 21.6 13.8 0 22.6-5.4 22.6-26.5V237.7h42.1v143.7zm99.6 63.5c-39.1 0-64.4-18.6-76.7-43l34.3-19.8c9 14.7 20.8 25.6 41.5 25.6 17.4 0 28.6-8.7 28.6-20.8 0-14.4-11.4-19.5-30.7-28l-10.5-4.5c-30.4-12.9-50.5-29.2-50.5-63.5 0-31.6 24.1-55.6 61.6-55.6 26.8 0 46 9.3 59.8 33.7L368 290c-7.2-12.9-15-18-27.1-18-12.3 0-20.1 7.8-20.1 18 0 12.6 7.8 17.7 25.9 25.6l10.5 4.5c35.8 15.3 55.9 31 55.9 66.2 0 37.8-29.8 58.6-69.7 58.6z" />
                </svg>
                <p>Javascript</p>
            </div>
            <div class="w-max flex flex-col items-center text-indigo-600 shadow-sm shadow-indigo-500 rounded-lg hover:scale-110 transition duration-700">
                <svg class="fill-indigo-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                    <path
            ...
            <div class="w-max flex flex-col items-center text-blue-700 shadow-sm shadow-blue-600 rounded-lg hover:scale-110 transition duration-700">
                <svg class="fill-blue-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    <path
        ...
        <p class="title text-xl text-slate-50 text-justify mt-10 mb-10">I also know how to work with the following frameworks :
        </p>
        <div class="skills flex flex-row gap-5 mb-16">
            <div class="w-max flex flex-col items-center text-sky-400 shadow-sm shadow-sky-300 rounded-lg hover:scale-110 transition duration-700">
                <svg class="fill-sky-400" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 512 512"
                    fill="currentColor">
                    <path
            ...
            <div class="w-max flex flex-col items-center text-emerald-500 shadow-sm shadow-emerald-400 rounded-lg hover:scale-110 transition duration-700">
                <svg class="fill-emerald-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path
        ...
        <div class="skills flex flex-row gap-5 mb-10">
            ...
            <div class="w-max flex flex-col items-center text-gray-300 shadow-sm shadow-gray-200 rounded-lg hover:scale-110 transition duration-700">
                <svg class="fill-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                    <path
            ...
            <div class="w-max flex flex-col items-center text-slate-400 shadow-sm shadow-slate-300 rounded-lg hover:scale-110 transition duration-700">
                <svg class="fill-slate-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor">
                    <path
            ...
            <div class="w-max flex flex-col items-center text-sky-600 shadow-sm shadow-sky-500 rounded-lg hover:scale-110 transition duration-700">
                <svg class="fill-sky-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" fill="currentColor">
                    <path
